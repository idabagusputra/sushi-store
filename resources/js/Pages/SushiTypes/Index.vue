...
const onSearch = (search) => {
    location.href = `/sushis/types?search=${search}`;
};
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="w-full flex">
                        <div class="w-1/2">
                            <Link :href="route('sushis.types.create')">
                                <PrimaryButton>
                                    Add New Sushi Type
                                </PrimaryButton>
                            </Link>
                            <Link :href="route('sushis.types.trashed')">
                        ...
                        <div class="w-1/2">
                            <TextInput
                                ...
                                type="text"
                                class="block w-full"
                                placeholder="Search Sushi Types..."
                                v-model="search"
